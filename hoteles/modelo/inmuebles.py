...
from modelo.departamentos import Departamentos
from modelo.caracteristicas import Caracteristicas
from modelo.ciudades import Ciudades
from modelo.sectores import Sectores
from modelo.direcciones import Direcciones
...
class Inmuebles(models.Model):
    ...
    idPais = models.ForeignObject(Paises, on_delete=models.CASCADE)
